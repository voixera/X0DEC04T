...
if Tabs.Main then
    ...
    Lbl(T, "Border RP - Full Auto Flow")
    Lbl(T, "Buy > Spawn Car > Sit > Remove Tires")
    Lbl(T, "> TP Car > Sell > TP Laundry > Loop")
    Sec(T, "System")
...
if Tabs.Smuggler then
    ...
    Lbl(T, "Buy -> SpawnCar -> Sit -> RemoveTires")
    Lbl(T, "-> TPCar -> Sell -> Laundry -> Loop")
