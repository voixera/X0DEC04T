    ...
    for _, plr in ipairs(Players:GetPlayers()) do
        if plr ~= LocalPlayer then
            ...
            if char and not Role.IsFakeCharacter(char) then
                ...
                -- Only create ESP if enabled AND we haven't cached this character yet
                ...
                elseif not isKiller and not State.ESP_Survivors and not State.ESP_Killer then
                    -- Clear if both disabled
                    ESP.Clear(char)
...
--═══════════════════════════════════════════════════════════════
-- MOVEMENT TAB CONTENT (SAFE - NO DROPDOWNS)
--═══════════════════════════════════════════════════════════════
...
--═══════════════════════════════════════════════════════════════
-- VISUALS TAB CONTENT (ALL PCALL-WRAPPED)
--═══════════════════════════════════════════════════════════════
...
--═══════════════════════════════════════════════════════════════
-- SETTINGS TAB CONTENT (ULTRA-SAFE)
--═══════════════════════════════════════════════════════════════
